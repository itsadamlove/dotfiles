...
let g:ale_linters = {'javascript': ['eslint'], 'python': ['flake8'], 'markdown': ['remark-lint'], 'css': ['stylelint'], 'scss': ['stylelint'], 'json': ['fixjson']}
let g:ale_fixers = {'javascript': ['prettier', 'eslint'], 'python': ['autopep8'], '*': ['remove_trailing_lines', 'trim_whitespace'], 'markdown': ['remark-lint'], 'css': ['stylelint', 'prettier'], 'scss': ['stylelint', 'prettier'], 'json': ['fixjson']}
